...
public class FrameTest extends javax.swing.JFrame {
    ...
    public FrameTest() {
        ...
        dtm = (DefaultTableModel) tblTest.getModel();
        fillTable();
        dongho();
    ...
    void fillTable() {
        dtm.setRowCount(0);
            dtm.addRow(new Object[]{
                ((JTextField) jdcDate.getDateEditor().getUiComponent()).getText().trim()});
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jdcDate, javax.swing.GroupLayout.PREFERRED_SIZE, 254, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jDesktop1.setLayer(jPanel4, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        lblDongHo.setBackground(new java.awt.Color(0, 102, 255));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        JOptionPane.showMessageDialog(this, ((JTextField) jdcDate.getDateEditor().getUiComponent()).getText().trim());
        fillTable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrameTest.class
